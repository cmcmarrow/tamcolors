...
setup(
    ...
    packages=["tamcolors",
              ...
              "tamcolors.tam_c._win_tam_c.vs_dlls",
              "tamcolors.tam_c._win_tam_c.vs_dlls.arm",
              "tamcolors.tam_c._win_tam_c.vs_dlls.x64",
              "tamcolors.tam_c._win_tam_c.vs_dlls.x86",
              "tamcolors.tam_c._uni_tam_c"],

    package_data={"tamcolors.tam_c._win_tam_c": ["*.cpp", "*.h"],
                  "tamcolors.tam_c._uni_tam_c": ["*.cpp", "*.h"],
                  "tamcolors.tam_c._win_tam_c.vs_dlls.arm": ["*.dll"],
                  "tamcolors.tam_c._win_tam_c.vs_dlls.x64": ["*.dll"],
                  "tamcolors.tam_c._win_tam_c.vs_dlls.x86": ["*.dll"]},
