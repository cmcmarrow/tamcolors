...
class TMAPrintTest(unittest.TestCase):
    def test_tma_print(self):
        buffer = tam.tma_buffer.TMABuffer(6, 5, "@", 1, 2)
        tam_tools.tma_print.tma_print(buffer, 0, 1, "Test", 3, 4)
    ...
    def test_tma_print_2(self):
        buffer = tam.tma_buffer.TMABuffer(7, 5, "@", 1, 2)
        buffer.set_spot(3, 1, "E", 8, 9)
        tam_tools.tma_print.tma_print(buffer, 2, 1, "Test", 3, -1)
    ...
    def test_tma_print_3(self):
        buffer = tam.tma_buffer.TMABuffer(7, 5, "@", 1, 2)
        buffer.set_spot(3, 1, "E", 8, 9)
        tam_tools.tma_print.tma_print(buffer, 2, 1, "Test\n\tcat", 3, -1)
        self.assertEqual(buffer.get_spot(2, 1), ("T", 3, 2))
        self.assertEqual(buffer.get_spot(3, 1), ("e", 3, 9))
        self.assertEqual(buffer.get_spot(4, 1), ("s", 3, 2))
        self.assertEqual(buffer.get_spot(5, 1), ("t", 3, 2))
    ...
    def test_tma_print_5(self):
        buffer = tam.tma_buffer.TMABuffer(7, 5, "@", 1, 2)
        buffer.set_spot(3, 1, "E", 8, 9)
        self.assertRaises(tam_tools.tma_str.TMAStrError,
                          tam_tools.tma_print.tma_print,
                          buffer,
                          2,
                          1,
                          "Test\n\r\tcat",
...
class TMAFilmTest(unittest.TestCase):
    def test_init_film(self):
        film = tam_tools.tma_film.TMAFilm([tam.tma_buffer.TMABuffer(4, 5, "A", 5, 6),
                                           tam.tma_buffer.TMABuffer(4, 5, "C", 4, 3)],
                                          circular=True)
    ...
    def test_setitem(self):
        ...
        tma_buffer = tam.tma_buffer.TMABuffer(5, 6, "T", 9, 1)
        film[1] = tma_buffer
    ...
    def test_setitem_2(self):
        ...
        self.assertRaises(tam_tools.tma_film.TMAFilmError,
                          film.__setitem__,
                          "key",
                          tam.tma_buffer.TMABuffer(8, 5, "B", 1, 9))
    ...
    def test_getitem(self):
        tma_buffer = tam.tma_buffer.TMABuffer(4, 5, "A", 5, 6)
        tma_buffer_2 = tam.tma_buffer.TMABuffer(4, 5, "B", 4, 3)
        tma_buffer_3 = tam.tma_buffer.TMABuffer(4, 5, "C", 4, 3)
        film = tam_tools.tma_film.TMAFilm((tma_buffer, tma_buffer_2, tma_buffer_3), circular=False)
    ...
    def test_getitem_2(self):
        tma_buffer = tam.tma_buffer.TMABuffer(4, 5, "A", 5, 6)
        tma_buffer_2 = tam.tma_buffer.TMABuffer(4, 5, "B", 4, 3)
        film = tam_tools.tma_film.TMAFilm((tma_buffer, tma_buffer_2), circular=False)

        self.assertIs(film[0], tma_buffer)
        self.assertIs(film[1], tma_buffer_2)

        self.assertRaises(tam_tools.tma_film.TMAFilmError, film.__getitem__, "id")
    ...
    def test_getitem_3(self):
        ...
        self.assertRaises(tam_tools.tma_film.TMAFilmError, film.__getitem__, 2)
    ...
    def test_next_2(self):
        ...
        film = tam_tools.tma_film.TMAFilm((tma_buffer, tma_buffer_2, tma_buffer_3), circular=True)
    ...
    def test_len(self):
        film = tam_tools.tma_film.TMAFilm([], circular=True)
    ...
    def test_get_2(self):
        ...
        self.assertRaises(tam_tools.tma_film.TMAFilmError, film.get, "id")
    ...
    def test_get_3(self):
        ...
        self.assertRaises(tam_tools.tma_film.TMAFilmError, film.get, 2)
    ...
    def test_append(self):
        ...
        self.assertEqual(len(film), 2)
        film.append(tam.tma_buffer.TMABuffer(3, 2, "Q", 6, 7))
        self.assertEqual(len(film), 3)

        film.append(tam.tma_buffer.TMABuffer(3, 2, "P", 6, 7))
    ...
    def test_done_3(self):
        film = tam_tools.tma_film.TMAFilm((), circular=False)
...
class TMAColorPaletteTest(unittest.TestCase):
    def test_init_color_palette(self):
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(range(1, 25))
        self.assertIsInstance(color_palette, tam_tools.tma_color_palette.TMAColorPalette)

    def test_init_color_palette_2(self):
        rules = {6: tam_tools.tma_color_palette.TMADefaultColor(5),
                 7: tam_tools.tma_color_palette.TMACycleColor((1, 2), 5)}
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(range(1, 5), rules)
        self.assertIsInstance(color_palette, tam_tools.tma_color_palette.TMAColorPalette)
    ...
    def test_str_2(self):
        rules = {6: tam_tools.tma_color_palette.TMADefaultColor(6),
                 7: tam_tools.tma_color_palette.TMACycleColor((7, 2), 5)}
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(range(1, 6), rules)
    ...
    def test_getitem_3(self):
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(range(1, 25))
        self.assertRaises(tam_tools.tma_color_palette.TMAColorPaletteError, color_palette.__getitem__, -1)
    ...
    def test_setitem_3(self):
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(range(1, 25))
        self.assertRaises(tam_tools.tma_color_palette.TMAColorPaletteError, color_palette.__setitem__, {}, 45)
    ...
    def test_get_color_3(self):
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(range(1, 25))
        self.assertRaises(tam_tools.tma_color_palette.TMAColorPaletteError, color_palette.get_color, -1)
    ...
    def test_set_color_3(self):
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(range(1, 25))
        self.assertRaises(tam_tools.tma_color_palette.TMAColorPaletteError, color_palette.set_color, {}, 45)
    ...
    def test_update(self):
        rules = {6: tam_tools.tma_color_palette.TMADefaultColor(5),
                 7: tam_tools.tma_color_palette.TMACycleColor((1, 2), 1)}
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(range(1, 10), rules)
    ...
    def test_set_rule(self):
        color_palette = tam_tools.tma_color_palette.TMAColorPalette()
        rule = tam_tools.tma_color_palette.TMADefaultColor(66)
    ...
    def test_set_rule_2(self):
        color_palette = tam_tools.tma_color_palette.TMAColorPalette()
        rule = tam_tools.tma_color_palette.TMADefaultColor(66)
        self.assertRaises(tam_tools.tma_color_palette.TMAColorPaletteError, color_palette.set_rule, {}, rule)
...
class TMADefaultColorTest(unittest.TestCase):
    def test_init_default_color(self):
        default_color = tam_tools.tma_color_palette.TMADefaultColor(45)
        self.assertIsInstance(default_color, tam_tools.tma_color_palette.TMAColorPaletteRule)
        self.assertIsInstance(default_color, tam_tools.tma_color_palette.TMADefaultColor)
    ...
    def test_update(self):
        default_color = tam_tools.tma_color_palette.TMADefaultColor(45)
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(color_rules={12: default_color})
        color_palette.update()
...
class TMACycleColor(unittest.TestCase):
    def test_init_cycle_color(self):
        cycle_color = tam_tools.tma_color_palette.TMACycleColor((1, 2, 3, 4), clock=1)
        self.assertIsInstance(cycle_color, tam_tools.tma_color_palette.TMAColorPaletteRule)
        self.assertIsInstance(cycle_color, tam_tools.tma_color_palette.TMACycleColor)

    def test_set_colors(self):
        cycle_color = tam_tools.tma_color_palette.TMACycleColor((4, 3, 2, 1), clock=1)
        color_palette = tam_tools.tma_color_palette.TMAColorPalette(color_rules={4: cycle_color})
        color_palette.update()
    ...
    def test_get_clock(self):
        cycle_color = tam_tools.tma_color_palette.TMACycleColor((1, 4), clock=2)
...
class TMAKeyManagerTest(unittest.TestCase):
    def test_init_key_manger(self):
        key_manger = tam_tools.tma_key_manager.TMAKeyManager()
        self.assertIsInstance(key_manger, tam_tools.tma_key_manager.TMAKeyManager)
...
class MakeTMAStrTest(unittest.TestCase):
    def test_make_tma_str(self):
        tma_str = tam_tools.tma_str.make_tma_str("test\t123")
        self.assertEqual(tma_str, "test    123")

    def test_make_tma_str_2(self):
        tma_str = tam_tools.tma_str.make_tma_str("test\t12\n3")
        self.assertEqual(tma_str, "test    12\n3")

    def test_make_tma_str_3(self):
        self.assertRaises(tam_tools.tma_str.TMAStrError, tam_tools.tma_str.make_tma_str, "123\r123")

    def test_make_tma_str_4(self):
        tma_str = tam_tools.tma_str.make_tma_str("test\r12\n3", bad_char="%^&")
        self.assertEqual(tma_str, "test%^&12\n3")

    def test_make_tma_str_5(self):
        tma_str = tam_tools.tma_str.make_tma_str("\r\\\n\ng\n", end_line="45", bad_char="@")
        self.assertEqual(tma_str, "@\\4545g45")


class TMATextBoxTest(unittest.TestCase):
    def test_tma_text_box_init(self):
        text_box = tam_tools.tma_text_box.TMATextBox("hello world!", 20, 34, "#", 3, 5)
        self.assertIsInstance(text_box, tam_tools.tma_text_box.TMATextBox)
    ...
    def test_tma_text_box_str_2(self):
        text_box = tam_tools.tma_text_box.TMATextBox("cat world!\n123", 20, 34, "#", 3, 5)
        self.assertEqual(str(text_box), "cat world!\n123")

    def test_update(self):
        text_box = tam_tools.tma_text_box.TMATextBox("", 20, 15, "#", 3, 5)

        buffer = tam.tma_buffer.TMABuffer(20, 15, " ", 3, 5)
        buffer2 = tam.tma_buffer.TMABuffer(20, 15, "@", 1, 2)
    ...
    def test_draw(self):
        text_box = tam_tools.tma_text_box.TMATextBox("hello world!", 20, 15, "#", 3, 5)
        buffer = tam.tma_buffer.TMABuffer(20, 15, " ", 3, 5)
        buffer2 = tam.tma_buffer.TMABuffer(20, 15, "@", 1, 2)
        text_box.draw(buffer2)
        self.assertEqual(buffer, buffer2)
    ...
    def test_draw_2(self):
        text_box = tam_tools.tma_text_box.TMATextBox("hello world!", 20, 15, "#", 3, 5, clock=1)
        buffer = tam.tma_buffer.TMABuffer(20, 15, " ", 3, 5)
        buffer2 = tam.tma_buffer.TMABuffer(20, 15, "@", 1, 2)
        text_box.draw(buffer2)
        self.assertEqual(buffer, buffer2)
    ...
    def test_draw_3(self):
        text_box = tam_tools.tma_text_box.TMATextBox("hello world!\ncats\n1\n\nhi",
                                                     19,
                                                     16,
                                                     "#",
                                                     1,
        ...
        buffer = tam.tma_buffer.TMABuffer(19, 16, "%", 1, 2)
        buffer2 = tam.tma_buffer.TMABuffer(19, 16, "@", 3, 4)
    ...
    def test_done_2(self):
        text_box = tam_tools.tma_text_box.TMATextBox("hello world!", 20, 34, "#", 3, 5, clock=1)
        for _ in range(14):
            self.assertFalse(text_box.done())
            text_box.update()
        self.assertTrue(text_box.done())
    ...
    def test_get_colors_2(self):
        text_box = tam_tools.tma_text_box.TMATextBox("hello world!", 20, 34, "#", 6, 1)
    ...
    def test_get_dimensions_2(self):
        text_box = tam_tools.tma_text_box.TMATextBox("hello world!", 4, 3, "#", 3, 5)
        self.assertEqual(text_box.get_dimensions(), (4, 3))


class TMAPlacingTest(unittest.TestCase):
    def test__get_center(self):
        self.assertEqual(tam_tools.tma_placing._get_center(9, 3), 8)

    def test__get_center_2(self):
        self.assertEqual(tam_tools.tma_placing._get_center(90, 33), 74)

    def test__get_other_side(self):
        self.assertEqual(tam_tools.tma_placing._get_other_side(9, 3), 7)

    def test__get_other_side_2(self):
        self.assertEqual(tam_tools.tma_placing._get_other_side(90, 33), 58)

    def test__get_dimensions_wrapper(self):
        @tam_tools.tma_placing._get_dimensions
        def func(x, y, w, h):
            return x, y, w, h
    ...
    def test__get_dimensions_wrapper_2(self):
        ...
        def func(x, y, w, h):
            return x, y, w, h
        self.assertEqual(func(1, 2, None, None, tam.tma_buffer.TMABuffer(3, 4, "c", 8, 9)), (1, 2, 3, 4))

    def test__get_dimensions_wrapper_3(self):
        @tam_tools.tma_placing._get_dimensions
        def func(x, y, w, h):
            return x, y, w, h
        self.assertEqual(func(1, 2, 12, 15, tam.tma_buffer.TMABuffer(30, 40, "c", 8, 9)), (1, 2, 30, 40))

    def test_top_left(self):
        self.assertEqual(tam_tools.tma_placing.top_left(1, 2, 3, 4), (1, 2))

    def test_top_left_2(self):
        self.assertEqual(tam_tools.tma_placing.top_left(11, 23, 13, 24), (11, 23))

    def test_top_right(self):
        self.assertEqual(tam_tools.tma_placing.top_right(1, 2, 3, 4), (-1, 2))

    def test_top_right_2(self):
        self.assertEqual(tam_tools.tma_placing.top_right(11, 23, 15, 24), (-3, 23))

    def test_bottom_left(self):
        self.assertEqual(tam_tools.tma_placing.bottom_left(1, 2, 3, 4), (1, -1))

    def test_bottom_left_2(self):
        self.assertEqual(tam_tools.tma_placing.bottom_left(11, 23, 15, 24), (11, 0))

    def test_bottom_right(self):
        self.assertEqual(tam_tools.tma_placing.bottom_right(1, 2, 3, 4), (-1, -1))

    def test_bottom_right_2(self):
        self.assertEqual(tam_tools.tma_placing.bottom_right(11, 23, 15, 24), (-3, 0))

    def test_center(self):
        self.assertEqual(tam_tools.tma_placing.center(1, 2, 3, 4), (0, 0))

    def test_center_2(self):
        self.assertEqual(tam_tools.tma_placing.center(11, 23, 15, 24), (4, 11))


class TMAFilmFadeInTest(unittest.TestCase):
    def test_tma_fade_in(self):
        buffer = tam.tma_buffer.TMABuffer(4, 5, "A", 1, 2)
        buffer2 = tam.tma_buffer.TMABuffer(4, 5, "&", 3, 7)
        film = tam_tools.tma_fade.tma_fade_in(buffer, "&", 3, 7)
    ...
    def test_tma_fade_in_2(self):
        buffer = tam.tma_buffer.TMABuffer(4, 5, "A", 1, 2)
        buffer2 = tam.tma_buffer.TMABuffer(4, 5, "&", 3, 7)
        film = tam_tools.tma_fade.tma_fade_in(buffer, "&", 3, 7, reverse=True)
    ...
    def test_tma_fade_in_3(self):
        buffer = tam.tma_buffer.TMABuffer(2, 3, "A", 1, 2)
        buffer.set_spot(1, 1, "B", 6, 9)
        buffer2 = tam.tma_buffer.TMABuffer(2, 3, "&", 3, 7)
        film = tam_tools.tma_fade.tma_fade_in(buffer, "&", 3, 7)
    ...
    def test_tma_fade_in_4(self):
        ...
        buffer.set_spot(1, 1, "B", 6, 9)
        buffer2 = tam.tma_buffer.TMABuffer(2, 3, "&", 3, 7)
        film = tam_tools.tma_fade.tma_fade_in(buffer, "&", 3, 7, rand=[True])
...
class TMAMenuTest(unittest.TestCase):
    def test_TMAMenu(self):
        self.assertIsInstance(tam_tools.tma_menu.TMAMenu([], "a", {}), tam_tools.tma_menu.TMAMenu)

    def test_TMAMenu_2(self):
        buttons = (tam_tools.tma_menu.TMATextButton("Hello", 3, 4, 6, 2, lambda: None, 5, 2),
                   tam_tools.tma_menu.TMATextButton("By", 3, 6, 6, 2, lambda: None, 5, 2),
                   tam_tools.tma_menu.TMATextButton("12345678", 3, 8, 6, 2, lambda: None, 5, 2),
                   tam_tools.tma_menu.TMATextBoxButton("test", 3, 10, 12, 5, "#", 6, 2, lambda: None, 5, 2))
        ...
        self.assertIsInstance(tam_tools.tma_menu.TMAMenu(buttons, "a", goto_map), tam_tools.tma_menu.TMAMenu)

    def test_update(self):
        hit_button = tam_tools.tma_menu.TMATextButton("Hello", 3, 4, 6, 2, lambda: None, 5, 2)
        buttons = (hit_button,
                   tam_tools.tma_menu.TMATextButton("By", 3, 6, 6, 2, lambda: None, 5, 2),
                   tam_tools.tma_menu.TMATextButton("12345678", 3, 8, 6, 2, lambda: None, 5, 2),
                   tam_tools.tma_menu.TMATextBoxButton("test", 3, 10, 12, 5, "#", 6, 2, lambda: None, 5, 2))
        ...
        menu = tam_tools.tma_menu.TMAMenu(buttons, "a", goto_map)

        with unittest.mock.patch.object(tam_tools.tma_menu.TMATextButton, "__call__", return_value=None) as call:
    ...
    def test_update_3(self):
        hit_button = tam_tools.tma_menu.TMATextButton("Hello", 3, 4, 6, 2, lambda: None, 5, 2)
        hit_button_2 = tam_tools.tma_menu.TMATextButton("By", 3, 6, 6, 2, lambda: None, 5, 2)
        hit_button_3 = tam_tools.tma_menu.TMATextButton("12345678", 3, 8, 6, 2, lambda: None, 5, 2)
        hit_button_4 = tam_tools.tma_menu.TMATextBoxButton("test", 3, 10, 12, 5, "#", 6, 2, lambda: None, 5, 2)
    ...
    def test_draw(self):
        ...
        menu = tam_tools.tma_menu.TMAMenu(buttons, "a", goto_map)
        with unittest.mock.patch.object(tam_tools.tma_menu.TMATextButton, "draw", return_value=None) as text_draw:
            with unittest.mock.patch.object(tam_tools.tma_menu.TMATextBoxButton, "draw", return_value=None) as box_draw:
                buffer = tam.tma_buffer.TMABuffer(0, 0, " ", 1, 2)
                menu.draw(buffer)
    ...
    def test_get_call_key_2(self):
        ...
        menu = tam_tools.tma_menu.TMAMenu(buttons, "UP", goto_map)
    ...
    def test_get_on_2(self):
        hit_button = tam_tools.tma_menu.TMATextButton("Hello", 3, 4, 6, 2, lambda: None, 5, 2)
        buttons = (tam_tools.tma_menu.TMATextButton("By", 3, 6, 6, 2, lambda: None, 5, 2),
                   hit_button,
                   tam_tools.tma_menu.TMATextButton("12345678", 3, 8, 6, 2, lambda: None, 5, 2),
                   tam_tools.tma_menu.TMATextBoxButton("test", 3, 10, 12, 5, "#", 6, 2, lambda: None, 5, 2))
    ...
    def test_simple_menu_builder(self):
        ...
        menu = tam_tools.tma_menu.TMAMenu.simple_menu_builder(buttons, "a")
    ...
    def test_simple_menu_builder_2(self):
        ...
        menu = tam_tools.tma_menu.TMAMenu.simple_menu_builder(buttons, "a", up_keys=("U", "C"))
    ...
    def test_simple_menu_builder_3(self):
        ...
        menu = tam_tools.tma_menu.TMAMenu.simple_menu_builder(buttons, "a", up_keys=("A", "C"), down_keys=("D",), on=1)
    ...
    def test_simple_menu_builder_5(self):
        menu = tam_tools.tma_menu.TMAMenu.simple_menu_builder([], "a")
...
class TMATextButtonTest(unittest.TestCase):
    def test_init_TextButton(self):
        button = tam_tools.tma_menu.TMATextButton("Hello", 3, 4, 6, 2, lambda: None, 5, 2)

        self.assertIsInstance(button, tam_tools.tma_menu.TMATextButton)

    def test_init_TextButton_2(self):
        button = tam_tools.tma_menu.TMATextButton("Hello\nCats\t123",
                                                  3,
                                                  4,
                                                  6,
                                                  2,
    ...
    def test_draw(self):
        button = tam_tools.tma_menu.TMATextButton("Hello", 0, 0, 6, 2, lambda: None, 5, 2)

        buffer = tam.tma_buffer.TMABuffer(6, 6, " ", 0, 0)
    ...
    def test_on(self):
        button = tam_tools.tma_menu.TMATextButton("Hello 123\ncats", 2, 0, 6, 2, lambda: None, 5, 8)

        buffer = tam.tma_buffer.TMABuffer(15, 6, " ", 0, 0)
    ...
    def test_off_2(self):
        ...
        buffer = tam.tma_buffer.TMABuffer(19, 19, " ", 0, 0)
...
class TMATextBoxButtonTest(unittest.TestCase):
    def test_init_TextBoxButton(self):
        button = tam_tools.tma_menu.TMATextBoxButton("test", 3, 10, 20, 5, "#", 6, 2, lambda: None, 5, 2)
        self.assertIsInstance(button, tam_tools.tma_menu.TMATextBoxButton)

    def test_init_TextBoxButton_2(self):
        button = tam_tools.tma_menu.TMATextBoxButton("test_2\ncats",
                                                     4,
                                                     11,
                                                     22,
                                                     7,
    ...
    def test_draw(self):
        button = tam_tools.tma_menu.TMATextBoxButton("test", 0, 0, 10, 5, "#", 6, 2, lambda: None, 5, 2)

        buffer = tam.tma_buffer.TMABuffer(12, 6, " ", 0, 0)
    ...
    def test_draw_2(self):
        ...
        buffer = tam.tma_buffer.TMABuffer(12, 12, " ", 0, 0)
    ...
    def test_on(self):
        button = tam_tools.tma_menu.TMATextBoxButton("test", 0, 0, 10, 5, "#", 6, 2, lambda: None, 5, 1)
    ...
    def test_on_2(self):
        ...
        buffer = tam.tma_buffer.TMABuffer(15, 15, " ", 0, 0)
...
class TMAListBufferTest(unittest.TestCase):
    def test_tma_list_buffer(self):
        ...
        tma_buffer = tam.tma_buffer.TMABuffer(3, 2, " ", 1, 2)
        for i in range(3):
            tma_buffer.set_spot(i, 0, str(i + 1), 1, 2)
            tma_buffer.set_spot(i, 1, str(i + 4), 1, 2)

        ret_tma_buffer = tam_tools.tma_list_buffer.tma_list_buffer(buffer, 1, 2)
    ...
    def test_tma_list_buffer_2(self):
        ...
        tma_buffer = tam.tma_buffer.TMABuffer(3, 3, " ", 1, 2)
        for i in range(3):
            tma_buffer.set_spot(i, 0, str(i + 1), 1, 2)
            tma_buffer.set_spot(i, 1, str(i + 4), 1, 2)
    ...
    def test_tma_list_buffer_3(self):
        ...
        ret_tma_buffer = tam_tools.tma_list_buffer.tma_list_buffer(buffer, foreground_colors, 2)
    ...
    def test_tma_list_buffer_4(self):
        ...
        ret_tma_buffer = tam_tools.tma_list_buffer.tma_list_buffer(buffer, 1, background_colors)
    ...
    def test_tma_list_buffer_5(self):
        ...
        ret_tma_buffer = tam_tools.tma_list_buffer.tma_list_buffer(buffer, foreground_colors, background_colors)
